...
for (let i = 0; i < projects.length; i++) {
    ...
    var btnUpperBox = $("<a href='" + projects[i].github + "' rel='noopener'><button><i class='fab fa-github'></i></button></a>");
    var lowerBox = $("<div class='message-body messageBackground'><a href='" + projects[i].url + "' rel='noopener'><img src='" + projects[i].image + "' width='200' height='200'></img></a></div>");
